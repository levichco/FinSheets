  ...
  useEffect(() => {
    ...
    if (pivotInteractive) {
      try {
        ...
        // DOM-level trigger — read the (double-click-updated) active cell on the next tick, then
        // drill. Registered independently of the Facade DblClicked attempt below (an unknown event
        // name can throw). NOTE: like the single-click collapse handler this depends on the Univer
        // selection surface; the panel is the source of truth for pivot edits.
        if (container) {
